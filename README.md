...
**isCabinBaggageIncluded:** A boolean indicating whether the user has activated the cabin baggage included filter.
...
* **baggageIncluded**: only show flights where checked baggage is included/added to in the ticket price. Business/First/Economy Plus automatically pass this filter
